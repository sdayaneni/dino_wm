...
python plan.py model_name=2025-09-02/22-22-39 n_evals=5 planner=cem goal_H=5 goal_source='random_state' planner.opt_steps=30 ckpt_base_path=/work/nvme/beig/sdayaneni/dino_wm