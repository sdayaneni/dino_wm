...
### LOG INFO ###
#SBATCH --job-name=train_rope
#SBATCH --output=logs/train/rope/train_rope_%A-%a.log
...
python train.py --config-name train.yaml env=deformable_env frameskip=1 num_hist=1 env.kwargs.object_name=rope env.dataset.object_name=rope